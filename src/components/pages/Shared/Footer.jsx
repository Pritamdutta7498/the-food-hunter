      ...
      <div className='p-10 bg-base-200 text-base-content '>
        <div className='px-10 md:px-32 grid grid-cols-1 md:grid-cols-3 place-items-stretch gap-3'>
          <div className='flex flex-col justify-end'>
            ...
            <a className="link link-hover">Hire Our Chefs</a>
            <a className="link link-hover">Buy Recipes</a>
          ...
          <div className='flex flex-col md:place-items-center'>
            <span className="footer-title">The Food Hunter</span>
      ...
      <div className='px-10 py-4 border-t bg-base-200 text-base-content border-base-300'>
        <footer className="footer px-10 md:px-32">
          <div className="items-center grid-flow-col ">
            <p>The Food Hunter <br />There is no sincere love than the love of food.</p>
          </div>
