    ...
    <div className='px-8 md:px-36 grid grid-cols-1 md:grid-cols-2 items-center'>
      <div className='p-5 md:p-10 py-10 md:py-16'>
        ...
        <h2 className='text-1xl md:text-3xl'>
          <span className='text-2xl md:text-3xl pl-1 md:pl-2 font-bold'>Want to cook something <span className='text-orange-400'>testy</span>? Read our <span className='text-orange-500'>best recipes</span> </span>
        </h2>
